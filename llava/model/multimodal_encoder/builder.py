...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    if 'qwen' in vision_tower.lower():
        kwargs.pop('delay_load', None)  # Remove delay_load if it exists
        return Qwen2_5_VisionTransformerPretrainedModelForLLaVA(vision_tower, args=vision_tower_cfg, **kwargs)
    elif vision_tower.startswith("openai") or vision_tower.startswith("laion") or "ShareGPT4V" in vision_tower or "clip" in vision_tower.lower():
        if use_s2:
